    ...
    <div class="container-fluid">
        <div class="position-relative mx-n4 mt-n4">
            <div class="profile-wid-bg profile-setting-img">
                <img src="{{ asset('assets/images/background/profile-bg.jpg') }}" class="profile-wid-img"
                    alt="">
            </div>
        </div>
        <div class="row">
                                            ...
                                            @if ($user->role_assign == 'Staff' || $user->role_assign == 'Teacher')
                                                <div class="col-6">
                                                    <label class="form-label">Personal Phone
                                                        Number *</label>
                                                    <input type="text" type="number" name="contact_no"
                                                        maxlength="13" value="{{ $user->contact_no }}"
                                                        class="form-control" autocomplete="off"
                                                        placeholder="+xxxxxxxxxxxx" oninput="NumberValidation(this)">
