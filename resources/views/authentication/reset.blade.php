                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide"
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        <div class="carousel-item active">
                                                            <p class="fs-15 fst-italic">"Going to hospital is rather like going to an alien planet!"</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">"An Atheist believes that a hospital should be built instead of a church!"</p>
                                                        </div>
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">"A hospital bed is a parked taxi with the meter running!"</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- end carousel -->
